...
export declare class TradingService {
    ...
    constructor(brokerService: BrokerService, subscriptionsService: SubscriptionsService, riskService: RiskService, executionService: ExecutionService, auditService: AuditService, eventBus: DomainEventBus);
